...
export default function Home() {
  ...
  return (
    <main className="page" onDragEnd={handleDragEnd}>
      ...
      <footer style={{textAlign:"center",marginTop:"48px",paddingBottom:"16px"}}>
        <a href="https://github.com/memeem27/Cipher-Stack" target="_blank" rel="noopener noreferrer" style={{color:"var(--text-muted)",fontSize:"0.78rem",textDecoration:"none",transition:"color 0.15s"}} onMouseEnter={e=>(e.currentTarget.style.color="var(--text-primary)")} onMouseLeave={e=>(e.currentTarget.style.color="var(--text-muted)")}>
          Github
        </a>
      </footer>
    </main>
